 ...
 *
 * <p><b>Filosofía:</b> las esperas explícitas son más confiables que las implícitas
 * porque esperan una <i>condición específica</i> en lugar de un tiempo fijo.
 * Esta clase encapsula toda la lógica de {@link WebDriverWait} y {@link ExpectedConditions},
 * y elimina la necesidad de declarar {@code WebDriverWait} en cada Page Object.</p>
 *
 * <p><b>Principio de diseño:</b> agnóstica al framework de testing.
 * No conoce a Cucumber ni a JUnit. Solo depende de Selenium.</p>
 *
 * <p>El timeout se configura con la propiedad del sistema {@code -DexplicitWait=15}
 * (default: 15 segundos).</p>
 *
 * @author Erick
 */
public final class WaitUtils {
     ...
     *
     * @param locator localizador del elemento (By.id, By.cssSelector, etc.)
     ...
     * Útil para esperar que un spinner de carga desaparezca.
     */
    ...
    public static boolean waitForTextToContain(By locator, String expectedPartialText) {
        log.debug("⏳ Esperando que el texto contenga '{}' en: {}", expectedPartialText, locator);
        return newWait().until(
     ...
     * Útil después de clicks que disparan navegación.
     */
     ...
     * Acepta lambdas para condiciones complejas.
     *
     * <p>Ejemplo: esperar que un contador llegue a un valor:</p>
     * <pre>
     * WaitUtils.waitForCondition(
     *     ExpectedConditions.textToBe(By.id("cart-count"), "1")
     * );
     * </pre>
     */
    public static <T> T waitForCondition(org.openqa.selenium.support.ui.ExpectedCondition<T> condition) {
